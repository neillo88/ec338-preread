...
Dummy variables are used extensively in Microeconometrics. This because of the discrete nature of most policy 'treatments' studied in Microeconomics as well as the extensive use of fixed effects. A dummy variable, $D_i=\{0,1\}$, can be used to split the sample into two (or more) groups; e.g., treatment and control. 
