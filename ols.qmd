...
What are the dimensions of this equation? Well, $X'X$ is a $k\times k$ matrix and $\hat{\beta}$ a $k\times 1$ vector. Thus the left-hand side of the equation is a $k\times 1$ vector, as is the right-hand side. \[Check that you agree.\]
